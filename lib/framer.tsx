        ...
        return (
          <motion.button
            ...
            className={classNames(
              'text-xs md:text-lg relative rounded-md flex flex-wrap items-center h-10 px-2 md:px-4 z-20  cursor-pointer select-none transition-colors hover:text-white mb-0.5',
              {
                'text-black': !isActive, // Default color for non-active tabs
                'text-white/90 bg-black': isActive, // Color for active tabs
              },
            )}
