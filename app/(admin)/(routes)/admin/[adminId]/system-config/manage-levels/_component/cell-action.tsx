  ...
  const handleDeleteLevel = async (id:string) => {
    try {
      ...
      toast({
        ...
        description: "Please Level was deleted successfully...",
    ...
    <>
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
          ...
          {value?.editLevel && (
           <Link href={`/admin/${id}/system-config/manage-levels/${data?._id}`}>
             <DropdownMenuItem >
          ...
          {value?.deleteLevel && (
            <DropdownMenuItem onClick={() => handleDeleteLevel(data?._id)}>
