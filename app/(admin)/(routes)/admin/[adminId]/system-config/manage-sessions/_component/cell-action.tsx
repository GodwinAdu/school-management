  ...
  const handleDeleteSession = async (id:string) => {
    try {
      ...
      toast({
        ...
        description: "Please Session was deleted successfully...",
    ...
    <>
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
          ...
          {value?.editSession && (
           <Link href={`/admin/${id}/system-config/manage-sessions/${data?._id}`}>
             <DropdownMenuItem >
          ...
          {value?.deleteSession && (
            <DropdownMenuItem onClick={() => handleDeleteSession(data?._id)}>
